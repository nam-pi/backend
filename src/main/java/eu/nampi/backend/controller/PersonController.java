...
public class PersonController extends AbstractRdfController {
  ...
  public ResponseEntity<String> getPersons(@RequestHeader("accept") Lang lang,
      ...
      @RequestParam("text") Optional<Literal> text, @RequestParam("aspect") Optional<Resource> aspect) {
  ...
  @GetMapping(value = "/persons/{id}", produces = { "application/ld+json", "text/turtle", "application/rdf+xml",
      "application/n-triples" })
