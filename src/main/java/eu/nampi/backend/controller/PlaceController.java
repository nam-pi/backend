...
public class PlaceController extends AbstractRdfController {
  ...
  @GetMapping(value = "/places", produces = { "application/ld+json", "text/turtle", "application/rdf+xml",
  ...
  @GetMapping(value = "/places/{id}", produces = { "application/ld+json", "text/turtle", "application/rdf+xml",
      "application/n-triples" })
