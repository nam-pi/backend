...
public class SourceController extends AbstractRdfController {
  ...
  @GetMapping(value = "/sources", produces = { "application/ld+json", "text/turtle", "application/rdf+xml",
      "application/n-triples" })
  public ResponseEntity<String> getSources(@RequestHeader("accept") Lang lang,
