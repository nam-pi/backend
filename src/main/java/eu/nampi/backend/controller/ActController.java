...
public class ActController extends AbstractRdfController {
  ...
  public ResponseEntity<String> getActs(@RequestHeader("accept") Lang lang, Optional<Integer> page,
      Optional<Integer> pageIndex, Optional<Integer> limit, Optional<Integer> offset,
      Optional<OrderByClauses> orderBy, Optional<String> type, Optional<String> text,
      Optional<String> author, Optional<String> source) {
