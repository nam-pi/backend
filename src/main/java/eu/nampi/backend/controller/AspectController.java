...
public class AspectController extends AbstractRdfController {
  ...
  @GetMapping(value = "/aspects", produces = { "application/ld+json", "text/turtle", "application/rdf+xml",
  ...
  public ResponseEntity<String> getAspects(@RequestHeader("accept") Lang lang,
      ...
      @RequestParam("text") Optional<Literal> text, @RequestParam("participant") Optional<Resource> participant) {
  ...
  public ResponseEntity<String> postAspect(@RequestHeader("accept") Lang lang,
    ...
    String newAspect = aspectRepository.insert(lang, type.orElse(Core.aspect), label, text);
