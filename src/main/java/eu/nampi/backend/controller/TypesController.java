...
public class TypesController extends AbstractRdfController {
  ...
  @GetMapping(value = "/types", produces = { "application/ld+json", "text/turtle", "application/rdf+xml",
  ...
  public ResponseEntity<String> getTypes(@RequestHeader("accept") Lang lang,
      ...
      @RequestParam("orderBy") Optional<OrderByClauses> orderBy, @RequestParam("type") Resource type) {
    QueryParameters params = getParameters(page, pageIndex, limit, offset, orderBy, Optional.of(type),
        Optional.empty());
