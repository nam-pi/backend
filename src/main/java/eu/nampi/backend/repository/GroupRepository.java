...
public class GroupRepository extends AbstractHydraRepository {
  ...
  public Model findAll(QueryParameters params) {
    HydraCollectionBuilder builder =
        new HydraCollectionBuilder(endpointUri("groups"), Core.group, Api.groupOrderByVar, params);
  ...
  public String findAll(QueryParameters params, Lang lang) {
    ...
    return serialize(model, lang, ResourceFactory.createResource(endpointUri("groups")));
  }
