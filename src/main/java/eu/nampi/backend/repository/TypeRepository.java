...
public class TypeRepository extends AbstractHydraRepository {
  ...
  public String findAll(QueryParameters params, Lang lang) {
    ...
    HydraCollectionBuilder classesBuilder = new HydraCollectionBuilder(jenaService,
        endpointUri(ENDPOINT_NAME), RDFS.Resource, Api.typeOrderByVar, params, false, false);
    ...
    HydraCollectionBuilder propertiesBuilder = new HydraCollectionBuilder(jenaService,
        endpointUri("types"), RDFS.Resource, Api.typeOrderByVar, params, false, false);
