...
public class DocumentationRepository extends AbstractHydraRepository {
  ...
  public String get(Lang lang) {
    ...
    model.setNsPrefix("api", Api.getURI()).setNsPrefix("hydra", Hydra.getURI()).setNsPrefix("rdf", RDF.getURI())
        .setNsPrefix("rdfs", RDFS.getURI()).setNsPrefix("schema", SchemaOrg.getURI()).setNsPrefix("xsd", XSD.getURI())
        .setNsPrefix("core", Core.getURI());
    Class doc = new Class(endpointUri("doc"), "The NAMPI API documentation", Hydra.ApiDocumentation);
    doc.addDescription(
  ...
  private void addActClass(Class doc) {
    ...
    act.addSupportedProperty(new SupportedProperty(RDF.type, RDFS.Class, RDF.type.getLocalName(), true, false, false));
    act.addSupportedProperty(
        new SupportedProperty(RDFS.label, RDF.langString, RDFS.label.getLocalName(), true, false, false));
    ...
    act.addSupportedProperty(
        new SupportedProperty(Core.isAuthoredBy, Core.author, Core.isAuthoredBy.getLocalName(), true, false, false));
    act.addSupportedProperty(
        new SupportedProperty(Core.isAuthoredOn, Core.date, Core.isAuthoredOn.getLocalName(), true, false, false));
    act.addSupportedProperty(
        new SupportedProperty(RDFS.comment, RDF.langString, RDFS.comment.getLocalName(), true, false, false));
  ...
  private void addAspectClass(Class doc) {
    ...
    aspect
        .addSupportedProperty(new SupportedProperty(RDF.type, RDFS.Class, RDF.type.getLocalName(), true, false, false));
    aspect.addSupportedProperty(
        new SupportedProperty(RDFS.label, RDF.langString, RDFS.label.getLocalName(), true, false, false));
    aspect.addSupportedProperty(
        new SupportedProperty(RDFS.comment, RDF.langString, RDFS.comment.getLocalName(), true, false, false));
    aspect.addSupportedProperty(
        new SupportedProperty(Core.hasText, RDF.langString, Core.hasText.getLocalName(), true, false, false));
    aspect.addSupportedProperty(
        new SupportedProperty(Core.sameAs, SchemaOrg.URL, Core.sameAs.getLocalName(), true, false, false));
  ...
  private void addDateClass(Class doc) {
    ...
    date.addSupportedProperty(new SupportedProperty(RDF.type, RDFS.Class, RDF.type.getLocalName(), true, false, false));
    date.addSupportedProperty(
        new SupportedProperty(Core.hasDateTime, XSD.dateTime, Core.hasDateTime.getLocalName(), true, false, false));
  ...
  private void addEventClass(Class doc) {
    ...
    event.addSupportedProperty(
        new SupportedProperty(Core.takesPlaceAt, Core.place, Core.takesPlaceAt.getLocalName(), true, false, false));
    ...
    event.addSupportedProperty(
        new SupportedProperty(Core.hasParticipant, Core.agent, Core.hasParticipant.getLocalName(), true, true, false));
    event.addSupportedProperty(
        new SupportedProperty(Core.usesAspect, Core.aspect, Core.usesAspect.getLocalName(), true, true, false));
  ...
  private void addPersonClass(Class doc) {
    ...
    person.addSupportedProperty(
        new SupportedProperty(Core.sameAs, SchemaOrg.URL, Core.sameAs.getLocalName(), true, false, false));
    person.addSupportedProperty(
        new SupportedProperty(Core.isBornIn, Core.event, Core.isBornIn.getLocalName(), true, false, false));
    person.addSupportedProperty(
        new SupportedProperty(Core.diesIn, Core.event, Core.diesIn.getLocalName(), true, false, false));
  ...
  private void addSourceLocationClass(Class doc) {
    ...
    sourceLocation.addSupportedProperty(
        new SupportedProperty(Core.hasSource, Core.source, Core.hasSource.getLocalName(), true, false, false));
    sourceLocation.addSupportedProperty(
        new SupportedProperty(Core.hasText, XSD.xstring, Core.hasText.getLocalName(), true, false, false));
  ...
  private void addUserClass(Class doc) {
    ...
    user.addSupportedProperty(
        new SupportedProperty(SchemaOrg.name, XSD.xstring, SchemaOrg.name.getLocalName(), true, false, false));
    ...
    user.addSupportedProperty(
        new SupportedProperty(SchemaOrg.email, XSD.xstring, SchemaOrg.email.getLocalName(), true, false, false));
    user.addSupportedProperty(
        new SupportedProperty(Core.sameAs, SchemaOrg.URL, Core.sameAs.getLocalName(), true, false, false));
  ...
  private void addSupportedCollections(Class doc) {
    ...
    doc.add(Hydra.supportedClass, acts, aspects, authors, events, groups, persons, places, sources, types);
  }
