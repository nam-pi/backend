...
public class DocumentationRepository extends AbstractHydraRepository {
  ...
  public String get(Lang lang) {
    ...
    model.setNsPrefix("doc", Doc.getURI()).setNsPrefix("hydra", Hydra.getURI()).setNsPrefix("rdf", RDF.getURI())
  ...
  private void addActClass(Class doc) {
    ...
    act.addSupportedProperty(
        new SupportedProperty(RDFS.label, XSD.xstring, RDFS.label.getLocalName(), true, false, false));
    ...
    act.addSupportedProperty(
        new SupportedProperty(RDFS.comment, XSD.xstring, RDFS.comment.getLocalName(), true, false, false));
  ...
  private void addAspectClass(Class doc) {
    ...
    aspect.addSupportedProperty(
        new SupportedProperty(RDFS.label, XSD.xstring, RDFS.label.getLocalName(), true, false, false));
    aspect.addSupportedProperty(
        new SupportedProperty(Core.hasXsdString, XSD.xstring, Core.hasXsdString.getLocalName(), true, false, false));
    aspect.addSupportedProperty(
        new SupportedProperty(SchemaOrg.sameAs, SchemaOrg.URL, SchemaOrg.sameAs.getLocalName(), true, false, false));
  ...
  private void addEventClass(Class doc) {
    ...
    event.addSupportedProperty(
        new SupportedProperty(Core.hasParticipant, Core.agent, Core.hasParticipant.getLocalName(), true, false, false));
    event.addSupportedProperty(
        new SupportedProperty(Core.usesAspect, Core.aspect, Core.usesAspect.getLocalName(), true, true, true));
