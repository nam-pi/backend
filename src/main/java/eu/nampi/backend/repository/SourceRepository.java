...
public class SourceRepository extends AbstractHydraRepository {
  ...
  public Model findAll(QueryParameters params) {
    HydraCollectionBuilderOld hydra = new HydraCollectionBuilderOld(params, Core.source, Doc.sourceOrderByVar);
    addData(hydra);
  ...
  public String findOne(Lang lang, UUID id) {
    ...
    HydraSingleBuilderOld builder = new HydraSingleBuilderOld(uri, Core.source);
    addData(builder);
